...
const TEXT_QUESTIONS = [
  ...
  { q: 'Which is the largest ocean on Earth?', a: 'Pacific Ocean', cat: 'geo', d: 'easy' },
  ...
  { q: 'What is the capital of Mongolia?', a: 'Ulaanbaatar', cat: 'geo', d: 'impossible' },
  ...
  { q: 'Which kingdom did the United States declare independence from?', a: '(The kingdom of) Great Britain', cat: 'hist', d: 'easy' },
  ...
  { q: 'How many states are in the USA?', a: '50', cat: 'hist', d: 'easy' },
  { q: 'What do the stripes on the American flag represent', a: 'The original 13 colonies', cat: 'hist', d: 'med' },
  ...
  { q: 'Which civilization built the city of Machu Picchu?', a: 'Inca', cat: 'hist', d: 'hard' },
  ...
  { q: 'What process converts sunlight, carbon dioxide, and water into food for plants?', a: 'Photosynthesis', cat: 'sci', d: 'basic' },
  ...
  { q: 'What part of a cell contains its DNA?', a: 'Nucleus', cat: 'sci', d: 'med' },
  ...
  { q: 'What subatomic particle carries a negative electric charge?', a: 'Electron', cat: 'sci', d: 'med' },
  ...
  { q: 'How fast does light travel, roughly?', a: 'About 300,000 km/s', cat: 'sci', d: 'expert' },
  { q: 'What is the SI unit of electrical resistance?', a: 'Ohm (Ω)', cat: 'sci', d: 'expert' },
  { q: 'What is the rarest naturally occurring element on Earth?', a: 'Astatine', cat: 'sci', d: 'impossible' },

  // --- Animals & Nature ---------------------------------------------------
  { q: 'How many legs does a spider have?', a: '8', cat: 'nature', d: 'basic' },
  { q: 'What do caterpillars turn into?', a: 'Butterflies (or moths)', cat: 'nature', d: 'basic' },
  { q: 'What is the largest land animal?', a: '(African bush) elephant', cat: 'nature', d: 'easy' },
  { q: 'What is the fastest land animal?', a: 'Cheetah', cat: 'nature', d: 'easy' },
  { q: 'What is the largest animal ever known to have lived?', a: 'Blue whale', cat: 'nature', d: 'easy' },
  { q: 'What do you call an animal that eats only plants?', a: 'Herbivore', cat: 'nature', d: 'easy' },
  { q: 'What is the tallest animal in the world?', a: 'Giraffe', cat: 'nature', d: 'easy' },
  { q: 'Which animal’s range is this?', a: 'Penguins', cat: 'nature', d: 'easy', img: 'animals/penguin-range.png' },
  { q: 'Which animal’s range is this?', a: 'Polar bear', cat: 'nature', d: 'easy', img: 'animals/polar-bear-range.webp' },
  { q: 'Which animal’s range is this?', a: 'Red kangaroo', cat: 'nature', d: 'easy', img: 'animals/kangaroo-range.png' },
  { q: 'What usually causes ocean waves?', a: 'Wind', cat: 'nature', d: 'med' },
  { q: 'What is a group of lions called?', a: 'A pride', cat: 'nature', d: 'med' },
  { q: 'What is the only mammal capable of true flight?', a: 'Bat', cat: 'nature', d: 'med' },
  { q: 'What is the largest species of fish?', a: 'Whale shark', cat: 'nature', d: 'med' },
  { q: 'What term refers to life in the sea?', a: 'Marine', cat: 'nature', d: 'med' },
  { q: 'Which animal’s range is this? (Blue = its main range)', a: 'Great white shark', cat: 'nature', d: 'med', img: 'animals/great-white-shark-range.webp' },
  { q: 'Which animal’s range is this?', a: '(Giant) panda', cat: 'nature', d: 'med', img: 'animals/giant-panda-range.png' },
  { q: 'What animal is this? Be specific.', a: 'Asian (Asiatic) elephant', cat: 'nature', d: 'hard', img: 'animals/asian-elephant.webp' },
  { q: 'Which animal’s range is this? (Yellow = former range)', a: 'Tiger', cat: 'nature', d: 'hard', img: 'animals/tiger-range.webp' },
  { q: 'Which animal’s range is this?', a: 'Lemurs', cat: 'nature', d: 'hard', img: 'animals/lemur-range.webp' },
  { q: 'Which animal’s range is this?', a: 'Pinnipeds (seals, sea lions and walruses)', cat: 'nature', d: 'hard', img: 'animals/pinniped-range.webp' },
  { q: 'Which animal’s range is this? Be specific.', a: 'Brown bear', cat: 'nature', d: 'hard', img: 'animals/brown-bear-range.webp' },
  { q: 'What animal has three hearts?', a: 'Octopus (or squid, cuttlefish)', cat: 'nature', d: 'hard' },
  { q: 'What is the longest snake?', a: '(Reticulated) python', cat: 'nature', d: 'hard' },
  { q: 'A group of crows is known as a what?', a: 'A murder', cat: 'nature', d: 'hard' },
  { q: 'What do you call animals that live both in water and on land?', a: 'Amphibians (semiaquatic)', cat: 'nature', d: 'hard' },
  { q: 'Komodo dragons are native to which country?', a: 'Indonesia', cat: 'nature', d: 'expert' },
  { q: 'Aquatic refers to life in water. What term refers to life on land?', a: 'Terrestrial', cat: 'nature', d: 'expert' },
  { q: 'What is a group of owls called?', a: 'A parliament', cat: 'nature', d: 'expert' },
  { q: 'What is the largest species of penguin?', a: 'Emperor penguin', cat: 'nature', d: 'expert' },
  { q: 'What is the longest venomous snake?', a: 'King cobra', cat: 'nature', d: 'expert' },
  { q: 'Which animal’s range is this? (Pink = former range)', a: 'Jaguar', cat: 'nature', d: 'expert', img: 'animals/jaguar-range.webp' },
  ...
  { q: 'What animal is this?', a: 'Red panda', cat: 'nature', d: 'expert', img: 'animals/red-panda.webp' },
  ...
  { q: 'In tennis, how many tournaments are in a Grand Slam?', a: '4', cat: 'sport', d: 'med' },
  { q: 'What country has had the most men’s FIFA World Cup finals appearances (and losses)?', a: 'Germany (4W 4L)', cat: 'sport', d: 'hard' },
  { q: 'What do the rings on the Olympic flag symbolize?', a: 'Continents (global unity)', cat: 'sport', d: 'hard' },
  { q: 'In tennis, what is a score of zero called?', a: 'Love', cat: 'sport', d: 'hard' },
  { q: 'How many points is a touchdown worth in American football?', a: '6', cat: 'sport', d: 'hard' },
  { q: 'Rounded to one decimal place, how long is a marathon?', a: '42.2 km (26.2 miles)', cat: 'sport', d: 'hard' },
  ...
  // --- Music --------------------------------------------------------------
  { q: 'How many strings does a guitar have?', a: 'Six', cat: 'music', d: 'basic' },
  { q: 'What do you call the words of a song?', a: 'Lyrics', cat: 'music', d: 'basic' },
  { q: 'Who is known as the “King of Pop”?', a: 'Michael Jackson', cat: 'music', d: 'easy' },
  { q: 'How many musicians make up a quartet?', a: 'Four', cat: 'music', d: 'easy' },
  { q: 'The Beatles formed in what English city?', a: 'Liverpool', cat: 'music', d: 'med' },
  { q: 'What composer wrote his Ninth Symphony (“Ode to Joy”) while deaf?', a: 'Ludwig van Beethoven', cat: 'music', d: 'med' },
  { q: 'In music, what does “a cappella” mean?', a: 'Singing without instruments', cat: 'music', d: 'med' },
  { q: 'Who is the frontman of the band Coldplay?', a: 'Chris Martin', cat: 'music', d: 'med' },
  { q: 'What artist pivoted into pop with the album “1989”?', a: 'Taylor Swift', cat: 'music', d: 'med' },
  { q: 'To which family of instruments does the trumpet belong?', a: 'Brass', cat: 'music', d: 'hard' },
  { q: 'How many lines make up a musical stave (staff)?', a: '5', cat: 'music', d: 'hard' },
  { q: 'What Italian musical term means "at a walking pace"? It is also the title of an ABBA song.', a: 'Andante', cat: 'music', d: 'hard' },
  { q: 'How many keys does a full-size piano have?', a: '88', cat: 'music', d: 'expert' },
  { q: 'Who composed “The Four Seasons”?', a: 'Antonio Vivaldi', cat: 'music', d: 'expert' },
  { q: 'What Italian musical term means to play loudly?', a: 'Forte', cat: 'music', d: 'expert' },
  { q: 'In music, what does “staccato” mean?', a: 'Short and detached notes', cat: 'music', d: 'expert' },
  ...
  // --- Movies & TV --------------------------------------------------------
  { q: 'What animal is the cartoon character Mickey?', a: 'Mouse', cat: 'film', d: 'basic' },
  { q: 'What color is Shrek?', a: 'Green', cat: 'film', d: 'basic' },
  { q: 'A young wizard attends this School of Witchcraft and Wizardry.', a: 'Hogwarts', cat: 'film', d: 'easy' },
  { q: 'What is the highest film honor awarded by the Academy?', a: 'Oscar', cat: 'film', d: 'easy' },
  { q: 'In “The Lion King,” what is the name of the original king, Simba’s father?', a: 'Mufasa', cat: 'film', d: 'med' },
  { q: 'Which 1997 film won 11 Academy Awards?', a: 'Titanic', cat: 'film', d: 'med' },
  { q: 'Which actor played Will Turner in “Pirates of the Caribbean”?', a: 'Orlando Bloom', cat: 'film', d: 'med' },
  { q: 'In “Star Wars,” what is the name of Han Solo’s ship?', a: 'Millennium Falcon', cat: 'film', d: 'med' },
  { q: 'Which legendary comic book writer co-created Spider-Man and Iron Man?', a: 'Stan Lee', cat: 'film', d: 'med' },
  { q: 'Which reality show locks contestants in a house under 24/7 surveillance?', a: 'Big Brother', cat: 'film', d: 'med' },
  { q: 'Which director made “Pulp Fiction” and “Kill Bill”?', a: 'Quentin Tarantino', cat: 'film', d: 'med' },
  { q: 'Who directed the films “Jaws” and “E.T.”?', a: 'Steven Spielberg', cat: 'film', d: 'hard' },
  { q: 'What was the first Pixar film to win the Academy Award for Best Animated Feature?', a: 'Finding Nemo (2003)', cat: 'film', d: 'hard' },
  ...
  { q: 'What Dutch painter cut off part of his own ear?', a: 'Vincent van Gogh', cat: 'arts', d: 'med' },
  { q: 'In what Paris museum does the Mona Lisa hang?', a: 'The Louvre', cat: 'arts', d: 'med' },
  { q: 'Who painted the ceiling of the Sistine Chapel?', a: 'Michelangelo', cat: 'arts', d: 'med' },
  { q: 'Who wrote “Pride and Prejudice”?', a: 'Jane Austen', cat: 'arts', d: 'hard' },
  { q: 'Who is traditionally credited with writing the Iliad and the Odyssey?', a: 'Homer', cat: 'arts', d: 'hard' },
  { q: 'What Spanish artist co-founded the Cubism movement?', a: 'Pablo Picasso', cat: 'arts', d: 'hard' },
  { q: 'What Russian author wrote “War and Peace”?', a: 'Leo Tolstoy', cat: 'arts', d: 'expert' },
  { q: 'Who wrote the novels “1984” and “Animal Farm”?', a: 'George Orwell', cat: 'arts', d: 'expert' },
  { q: 'What Russian author wrote “Crime and Punishment”?', a: 'Fyodor Dostoevsky', cat: 'arts', d: 'impossible' },
  { q: 'What French author wrote the novel “In Search of Lost Time”?', a: 'Marcel Proust', cat: 'arts', d: 'impossible' },

  // --- Food & Drink -------------------------------------------------------
  { q: 'What fruit is traditionally used to make wine?', a: 'Grapes', cat: 'food', d: 'basic' },
  ...
  { q: 'Sushi is a traditional dish from what country?', a: 'Japan', cat: 'food', d: 'easy' },
  { q: 'The dish paella originates from what country?', a: 'Spain', cat: 'food', d: 'easy' },
  { q: 'What is the main ingredient in hummus?', a: 'Chickpeas', cat: 'food', d: 'med' },
  { q: 'What nut is used to make marzipan?', a: 'Almond', cat: 'food', d: 'med' },
  { q: 'What is tofu made from?', a: 'Soybeans', cat: 'food', d: 'hard' },
  { q: 'What spice, taken from a crocus flower, is the most expensive by weight?', a: 'Saffron', cat: 'food', d: 'hard' },
  { q: 'Champagne can only come from what region of France?', a: 'Champagne', cat: 'food', d: 'hard' },
  { q: 'What part of a tree does cinnamon come from?', a: 'The bark', cat: 'food', d: 'hard' },
  { q: 'Traditional Roquefort cheese is made from the milk of what animal?', a: 'Sheep', cat: 'food', d: 'expert' },
  { q: 'What type of pastry is used to make profiteroles?', a: 'Choux pastry', cat: 'food', d: 'impossible' },

  // --- Words & Language ---------------------------------------------------
  { q: 'How many letters are in the English alphabet?', a: '26', cat: 'words', d: 'basic' },
  { q: 'What punctuation mark is used to link two independent clauses that are closely related in thought?', a: 'Semicolon (;)', cat: 'words', d: 'basic' },
  { q: 'What do you call a word that means the opposite of another?', a: 'Antonym', cat: 'words', d: 'easy' },
  { q: 'What is the first letter of the Greek alphabet?', a: 'Alpha', cat: 'words', d: 'easy' },
  { q: 'What do you call a word that reads the same forwards and backwards?', a: 'Palindrome', cat: 'words', d: 'med' },
  { q: 'What language has the most native speakers in the world?', a: 'Mandarin Chinese', cat: 'words', d: 'med' },
  { q: 'The phrase “et cetera” comes from which ancient language?', a: 'Latin', cat: 'words', d: 'med' },
  { q: 'In grammar, what do you call a word that describes a verb?', a: 'Adverb', cat: 'words', d: 'hard' },
  ...
  { q: 'A comparison using “like” or “as,” such as “as brave as a lion,” is called a what?', a: 'A simile', cat: 'words', d: 'expert' },
  ...
  { q: 'What do you call a number divisible only by 1 and itself?', a: 'Prime', cat: 'math', d: 'med' },
  ...
  { q: 'What is the smallest prime number?', a: '2', cat: 'math', d: 'med' },
  ...
  { q: 'What name is given to the number 1 followed by 100 zeros?', a: 'Googol', cat: 'math', d: 'expert' },
  ...
  // --- General Knowledge --------------------------------------------------
  { q: 'What is known as the Red Planet?', a: 'Mars', cat: 'general', d: 'basic' },
  { q: 'How many months have 31 days?', a: '7', cat: 'general', d: 'basic' },
  { q: 'What is the currency of the United Kingdom?', a: 'Pound (sterling)', cat: 'general', d: 'basic' },
  { q: 'What is the third planet from the Sun?', a: 'Earth', cat: 'general', d: 'basic' },
  { q: 'How many colors are traditionally said to be in a rainbow?', a: '7', cat: 'general', d: 'easy' },
  ...
  { q: 'What is the currency of Turkey?', a: 'Lira', cat: 'general', d: 'med' },
  ...
  { q: 'What is the currency of South Korea?', a: 'Won', cat: 'general', d: 'hard' },
  { q: 'What has been the currency of Liechtenstein since 1920?', a: 'Swiss franc', cat: 'general', d: 'expert' },
